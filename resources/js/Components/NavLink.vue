...
const classes = computed(() => {
    return props.active
        ? 'inline-flex items-center px-4 py-3  rounded-sm  bg-blue-50 border-l-2 border-primary text-primary  text-sm font-medium leading-5  transition duration-150 ease-in-out'
