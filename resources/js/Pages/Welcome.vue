...
<template>
    ...
    <!-- banner -->
    <div class="bg-cover bg-no-repeat bg-center py-36 bg-opacity-40" style="background-image: url('assets/images/background/agriculture.jpg');">
        <div class="container">
            <h1 class="text-6xl text-red-200 font-medium mb-4 capitalize">
                best export <br> for all products
            </h1>
            ...
            <div class="mt-12">
                <a href="#" class="bg-primary border border-primary text-white px-8 py-3 font-medium 
                    rounded-md hover:bg-transparent hover:text-primary">Order Now</a>
            </div>
        </div>
    </div>
    <!-- ./banner -->
    ...
    <!-- categories -->
    <div class="container py-16">
        <h2 class="text-2xl font-medium text-gray-800 uppercase mb-6">order by category</h2>
